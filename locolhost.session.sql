...
--Nos aseguramos que estamos usando la base de datos vivero
show databases;
use vivero;

--3.1 Inserción de datos en la tabla oficina
...
--3.2 Inserción de datos en la tabla empleados
...
--3.3 Inserción de datos en la tabla gama_producto
...
--3.4 Inserción de datos en la tabla cliente
...
--3.5 inserción de datos en la tabla pedido
...
--3.6 Inserción de datos en la tabla producto
...
--3.6 inserción de datos en la tabla detalle_pedido;
...
--3.7 inserción de datos de la tabla pago
...
--Los siguientes registros no se puede debido a que solo hay 19 clientes(id_cliente:[1-19]) y se estan considedando los clientes (23,26,27,28,30,35,38) los cuales no se encuentran registrados en la base de datoss
